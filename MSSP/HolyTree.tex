...
then $slack(x \rightarrow y) = dist(x) + w(x \rightarrow y) - dist(y) = 
dist_0(x) + (0, -\vec{[h]}, -\alpha) + w(x \rightarrow y) - dist_0(y) = 
slack_0(x \rightarrow y) + (0, -\vec{[h]}, -\alpha)$.

$slack(x \rightarrow y) < 0$, if $slack_0(x \rightarrow y) < (0,\vec{[h]},\alpha)$
